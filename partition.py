...
def algoTest():
    ...
    if len(sys.argv) > 1:
        ...
        if code == 0:
            ...
            res = repRandom(A, max_iter, 's', 0)#not Main.flag)
        elif code == 2:
            res = hillClimb(A, max_iter, 's', 0) #not Main.flag)
        elif code == 3:
            res = simAnneal(A, max_iter, 's', 0)#not Main.flag)
        elif code == 11:
            res = repRandom(A, max_iter, 'p', 0)# not Main.flag)
        elif code == 12:
            res = hillClimb(A, max_iter, 'p', 0)
        elif code == 13:
            res = simAnneal(A, max_iter, 'p', 0)
